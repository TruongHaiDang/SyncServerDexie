...
Webocket server that can be used as a template for how to implement a sync server that interchange changes
                        ...
                        if (request.partial) {
                            ...
                            resolved.forEach(function (change) {
                                switch (change.type) {
                                    case CREATE:
                                        {
                                            ...
                                            mongo.addDocs("myApp", change.table, change.obj)
                                                .then(result => {
                                                    console.log(result)
                                                })
                                            break;
                                    ...
                                    case UPDATE:
                                        {
                                            db.update("myApp", change.key, change.mods, conn.clientIdentity);
                                            console.log(change);
                                            mongo.updateDocs("myApp", change.table, {_id: change.key}, change.mods)
                                                .then(result => {
                                                    console.log(result)
                                                })
                                            break;
                                    ...
                                    case DELETE:
                                        {
                                            db.delete("myApp", change.key, conn.clientIdentity);
                                            mongo.deleteDocs("myApp", change.table, {_id: change.key})
                                                .then(result => {
                                                    console.log(result)
                                                })
                                            break;
